...
SECRET_KEY = 'django-insecure-ify^hccaclkis8b@x+c48dnou*6jk**59&opy^*1hy3k=u2yo)'
...
ALLOWED_HOSTS = ['localhost','gpc-a.herokuapp.com','gpc-o.herokuapp.com']

CORS_ALLOW_ALL_ORIGINS = True

CORS_ALLOWED_ORIGINS = [
    'https://localhost',
    'https://gpc-a.herokuapp.com',
    'https://gpc-o.herokuapp.com'
]
